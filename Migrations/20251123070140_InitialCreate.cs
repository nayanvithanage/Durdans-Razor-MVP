    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorHospitals", x => new { x.DoctorsId, x.HospitalsId });
                    table.ForeignKey(
                        name: "FK_DoctorHospitals_Doctors_DoctorsId",
                        column: x => x.DoctorsId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorHospitals_Hospitals_HospitalsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorHospitals_HospitalsId",
